...
@SpringBootTest(classes = {DemoProducerService_optimizedBenchmarkTests.App.class})
...
@TestPropertySource(properties = {
        ...
        // override producer throughput settings in /resources/application-client.yml with optimized producer's settings
...
public class DemoProducerService_optimizedBenchmarkTests {
    private final static Logger LOGGER = LoggerFactory.getLogger(DemoProducerService_optimizedBenchmarkTests.class);
    ...
    void setApplicationContext(ConfigurableApplicationContext applicationContext) {
        DemoProducerService_optimizedBenchmarkTests.applicationContext = applicationContext;
        DemoProducerService_optimizedBenchmarkTests.producerService =
